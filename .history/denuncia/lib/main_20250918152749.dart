            ...
            _buildCard(
              Column(
                ...
                children: [
                  ...
                  _buildDataRow("Nombre", denuncia.numeroIdentificacion),
                  if (denuncia.apellidoPaterno != 'Anónimo')
                    _buildDataRow("Apellido Paterno", denuncia.apellidoPaterno),

                  if (denuncia.apellidoMaterno != 'Anónimo')
                    _buildDataRow("Apellido Materno", denuncia.apellidoMaterno),
