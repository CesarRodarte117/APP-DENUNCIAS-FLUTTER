          ...
          content: const SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  "\n"
                  "Artículo 93. La denuncia deberá contener los datos o indicios que permitan advertir la presunta responsabilidad administrativa..."
                  "\n\nPodrán ser presentadas de manera electrónica a través de los mecanismos que para tal efecto establezcan las Autoridades investigadoras.",
                  textAlign: TextAlign.justify,
                ),
              ],
            ),
