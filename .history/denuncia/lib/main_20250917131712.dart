        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                tileColor: Colors.white,
                title: const Text('Fundamento legal'),
                selected: _selectedIndex == 1,
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => FundamentosLegalesScreen(denuncia: null),
                    ),
                  );
                },
              ),
...
class FundamentosLegalesScreen extends StatefulWidget {
  final Denuncia? denuncia; // <- parámetro que indica a dónde ir

  // Constructor con parámetro requerido
  const FundamentosLegalesScreen({super.key, this.denuncia});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                " Articulo 93. La denuncia deberá contener los datos o indicios que permitan advertir la presunta responsabilidad administrativa por la comisión de"
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    // Revisar el valor del parámetro
                    if (widget.denuncia == null) {
                      // Si es 0, ir a un lado
                      Navigator.pop(context); // o lo que necesites
                    } else {
                      // Si no es 0, ir a otro lado
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  guardadoExitoso(denuncia: widget.denuncia!),
                        ),
                      );
                    }
                  },
                    ...
                    try {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  FundamentosLegalesScreen(denuncia: denuncia),
                        ),
                      );
                      setState(() {
                        _isCargando = false;
