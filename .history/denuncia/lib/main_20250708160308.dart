    ...
    if (_currentStep == 0) {
      ...
      return Column(
        children: [
          ...
          FileUploadSection(
            tipoEvidencia: evidenciaStatusValue, // El valor de tu dropdown
            onUrlObtenida: (url) {
              // Aquí recibes la URL cuando el archivo se sube correctamente
              print('Archivo subido: $url');
              // Puedes guardar esta URL donde necesites
            },
            onError: (error) {
              // Manejo de errores
              ScaffoldMessenger.of(
