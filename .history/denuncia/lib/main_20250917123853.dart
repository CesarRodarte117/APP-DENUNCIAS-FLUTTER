        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                " Articulo 93. La denuncia deberå contener los datos o indicios que permitan advertir la presunta responsabilidad administrativa por la comisidn de"
                "Faltas administrativas, y podr6n ser presentadas de manera electr6nica a través de los mecanismos que para tal efecto establezcan las Autoridades investigadoras, 10 anterior sin menoscabo de la plataforma"
                "digital que determine, para tal efect0* el Sistema Nacional Anticorrupcidn.",
                style: TextStyle(fontSize: 16, height: 1.5),
                textAlign: TextAlign.justify,
              ),
