      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildDataRow(
              "Dirección",
              "${denuncia.direccion} No.${denuncia.direccionNumero}",
            ),
            ...
            _buildDataRow("ECHO", denuncia.servidorEcho),
            ...
            _buildDataRow("Colonia del echo", denuncia.servidorColonia),
...
class FormDenunciaState extends State<FormDenuncia> {
  ...
  Denuncia _crearDenuncia() {
    return Denuncia(
      ...
      servidorNombre: _nombreController.text,
      servidorCargo: _apellidosController.text,
      servidorDependencia: dependenciaStatusValue,
      servidorIdentificacionDetalle: _sexoController.text,
      servidorEcho: echodropdownValue,
      servidorDistrito: _edadController.text,
      servidorDireccion: _direccionController.text,
      servidorDireccionCalles: _direccionNumeroController.text,
      servidorColonia: _coloniaController.text,
      servidorEvidencia: _correoController.text,
      servidorMotivo: _ocupacionController.text,
      servidorFechaOcurrido: _nacionalidadController.text,
