...
class _TermsAndConditionsScreenState extends State<TermsAndConditionsScreen> {
  ...
  // Función para mostrar el mensaje cuando el texto se toca
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("Aquí puedes ver los términos y condiciones."),
          actions: <Widget>[
            TextButton(
              onPressed: () {
      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            GestureDetector(
              onTap: _showTermsDialog,  // Muestra el diálogo cuando se toca el texto
              child: const Text(
            ...
            CheckboxListTile(
              ...
              controlAffinity: ListTileControlAffinity.leading, // Coloca la casilla a la izquierda
            ),
