    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text("Aquí puedes ver los términos y condiciones."),
          actions: <Widget>[
            TextButton(
              onPressed: () {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SwitchListTile(
                title: const Text('¿Denunciar de forma anonima?'),
                value: anonimoValue,
