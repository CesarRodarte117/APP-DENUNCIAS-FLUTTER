...
¡Exacto! Te diste cuenta del detalle. El problema es que tienes el asterisco puesto dos veces.

El RichText está mostrando:

Un primer asterisco en rojo: TextSpan(text: '* ')

Y luego un segundo asterisco en el texto normal: TextSpan(text: ' * Lugar del hecho')

El resultado final es que se ve * * Lugar del hecho.

La Solución
Simplemente quita el asterisco y el espacio del segundo TextSpan para que solo contenga el texto que quieres mostrar.

Así debe quedar tu hint:
...
Dart
              ...
              hint: RichText(
                text: const TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text: '* ', // 1. El asterisco en rojo
                      style: TextStyle(color: Colors.red, fontSize: 16),
                    ),
                    TextSpan(text: 'Lugar del hecho'), // 2. El texto normal (sin el asterisco)
                  ],
                ),
              ),
                  isExpanded: true,
