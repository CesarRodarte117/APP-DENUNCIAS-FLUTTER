            ...
            children: [
              Expanded(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  hint: RichText(
                    text: const TextSpan(
                      // Estilo por defecto para el texto del hint
                      style: TextStyle(
                        color: Colors.black54, // Color típico de un hint
                        fontSize: 16,
                      ),
                      children: <TextSpan>[
                        TextSpan(
                          text: '* ', // El asterisco rojo
                          style: TextStyle(color: Colors.red, fontSize: 16),
                        ),
                        TextSpan(text: 'Lugar del hecho'), // El texto normal
                      ],
                    ),
                  ),
                  isExpanded: true,
