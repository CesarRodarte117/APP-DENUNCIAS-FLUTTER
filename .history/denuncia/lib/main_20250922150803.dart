        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              // <-- Fíjate que es InputDecoration, no const
              // labelText: 'Nombre del servidor', // <-- Elimina esta línea
              label: RichText(
                // <-- Usa 'label' en su lugar
                text: const TextSpan(
                  children: [
                    TextSpan(
                      text: '* ', // El asterisco y un espacio
                      style: TextStyle(
                        color: Colors.red,
                      ), // Estilo solo para el asterisco
                    ),
                    TextSpan(
                      text: 'Nombre del servidor', // El resto del texto
                      // Este usará el estilo por defecto del tema
                    ),
                  ],
                ),
              ),
