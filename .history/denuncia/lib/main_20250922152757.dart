        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              label: RichText(
                text: TextSpan(
                  // Quita el 'const' de aquí para que herede el estilo
                  // PASO 2: Quita el color fijo de aquí para que la etiqueta cambie a rojo en error
                  style: const TextStyle(
                    fontSize: 16,
                    // color: Colors.black54, <-- LÍNEA ELIMINADA
                  ),
              ...
              // PASO 1: Agrega estos estilos para unificar el color del borde en error
              ...
              // Opcional: Para unificar el estilo del mensaje de error
