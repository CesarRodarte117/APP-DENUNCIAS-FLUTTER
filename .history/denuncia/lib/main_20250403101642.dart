          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(child: Text('Solter(a)')),
                  DropdownMenuItem(value: 'Casad(a)', child: Text('Casad(a)')),
                  DropdownMenuItem(value: 'Viud(a)', child: Text('Viud(a)')),
                  DropdownMenuItem(
                    value: 'Divorciad(a)',
                    child: Text('Divorciad(a)'),
                  ),
                  DropdownMenuItem(
                    value: 'union libre',
