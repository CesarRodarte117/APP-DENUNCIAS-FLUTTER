...
Claro, entiendo. Quieres la solución más directa posible.

Para agregar solo el asterisco rojo es necesario cambiar labelText por label, porque labelText (siendo solo texto) no permite tener dos colores diferentes.

Pero no te preocupes, el cambio es mínimo y no afectará en nada más a tu campo de texto. Visualmente se verá exactamente como quieres y la funcionalidad del controlador y el validador seguirán intactas.

El Cambio Mínimo (Copiar y Pegar)
Este es el código exacto que necesitas. Simplemente reemplaza tu decoration actual con este:

Dart

          decoration: InputDecoration( // <-- Solo quita 'const' de aquí
            label: RichText(
              text: const TextSpan(
                style: TextStyle( // Estilo por defecto para el texto del label
