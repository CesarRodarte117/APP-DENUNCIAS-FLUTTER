...
class _ListaDenunciasScreenState extends State<ListaDenunciasScreen> {
  // ✅ NUEVA FUNCIÓN ASÍNCRONA PARA ORDENAR EL PROCESO
  ...
  String _obtenerTextoEstatus(String? estatus) {
    switch (estatus) {
      ...
      case 'C':
        return 'Cerrada';
      // Agrega más casos si los tienes
      default:
        return 'Revisar';
    }
  }
  ...
  Color _obtenerColorEstatus(String? estatus) {
    switch (estatus) {
      case 'A':
        return Colors.green.shade700; // Verde para 'Activa'
      case 'P':
        return Colors.orange.shade700; // Naranja para 'Pendiente'
      case 'C':
        return Colors.red.shade700; // Rojo para 'Cerrada'
      default:
        return Colors.grey.shade700; // Gris para cualquier otro caso
    }
  }
            ...
            child: ElevatedButton(
              onPressed: () async {
                try {
                  ...
                  print('El ID único del dispositivo es: $id_unico');
                  ...
                  if (_formkey.currentState!.validate() && !hasErrors) {
                    ...
                    try {
                      ...
                      if (seSubioCorrectamente) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('✅ ¡Denuncia enviada con éxito!'),
