            ...
            _buildCard(
              Column(
                ...
                children: [
                  _buildDataRow(
                    "Calle",
                    'Pino Suarez #100, Zona Centro, ciudad Ju6rez, Chihuahua.',
                  ),
                  _buildDataRow("Teléfono", '(656)737-0000, extensi6n 70910'),
                ],
              ),
            ),
              ...
              onPressed: () async {
                try {
                  ...
                  if (visiblefecha == false) {
                    setState(() {
                      visiblefechamensaje = true;
                      fechamensaje = 'Selecciona una fecha';
                      cargandoText = 'Selecciona una fecha';
                      Duration(seconds: 2);
                      colorFecha = const Color.fromARGB(255, 212, 47, 47);
                      hasErrors = true;
                      _isCargando = false;
