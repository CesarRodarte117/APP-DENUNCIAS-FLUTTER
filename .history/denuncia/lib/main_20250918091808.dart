...
class FormDenunciaState extends State<FormDenuncia> {
  ...
  Denuncia _crearDenuncia() {
    return Denuncia(
      ...
      servidorFechaOcurrido: DateFormat(
        'dd/MM/yyyy',
      ).format(DateTime.parse(_servidorFechaOcurridoController.text)),
    ...
    if (_currentStep == 0) {
      ...
      stepContent = Column(
        children: [
          ...
          const SizedBox(height: 16),
          // mensaje si no subio un archivo
          if (_urlsEvidencias.isEmpty) Text('Debe subir un archivo'),
          if (_urlsEvidencias.isEmpty && intentar_enviar)
            Text(
