...
import 'package:denuncia/models/db.dart'; // Adjust the path to where Evidencia is defined
import 'package:denuncia/models/denuncia.dart'; // Adjust the path to where Denuncia is defined
