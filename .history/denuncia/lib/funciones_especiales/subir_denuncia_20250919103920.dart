...
class ApiService {
  ...
  static Future<bool> ObtenerDenunciasPorUsuario(
    String usuarioIdentificador,
  ) async {
    const String url =
        'https://apps.juarez.gob.mx/ws_cdenuncia/ws01/gestion_denuncias_por_usuario.json';
    ...
    try {
      ...
      // Agregamos el campo "denuncia" como si fuera Postman
      request.fields['usuario'] = usuarioIdentificador;
