...
class FileUploadSectionState extends State<FileUploadSection> {
  ...
  Future<int> _obtenerIdDenuncia(int idDenuncia) async {
  ...
  Future<void> guardarEvidenciasLocales(
    ...
    try {
      ...
      // Preparamos todas las evidencias primero
      for (var archivo in _archivosSeleccionados) {
        ...
        evidencias.add(
          Evidencia(
            ...
            url: '', // Puedes poner la URL aquí si la tienes
            pathLocal: localPath,
      ...
      // Guardamos todos los archivos y registros
      final db = await DatabaseHelper().database;
