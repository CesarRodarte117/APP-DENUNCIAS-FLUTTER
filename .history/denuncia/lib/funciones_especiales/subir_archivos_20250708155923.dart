...
class _FileUploadSectionState extends State<FileUploadSection> {
    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        setState(() {
          ...
          _tamañoArchivo = _formatearTamaño(result.files.first.size);
        });
      }
    } catch (e) {
  ...
  Future<void> _subirArchivo() async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('https://apps.juarez.gob.mx/ws_cdenuncia/ws02/insertar_evidencia.json'),
      );
      ...
      // Agregar parámetros
      request.fields['referencia'] = 'REF-123'; // Aquí debes poner tu referencia real
  ...
  String _formatearTamaño(int bytes) {
